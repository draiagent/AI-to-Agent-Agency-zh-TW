...
本專案**絕大多數不是原創**。41 位數位員工的角色設定、專業流程與方法論，皆來自：
...
| 5 | 行銷 marketing | content-creator ✅、growth-hacker ✅、seo-specialist ✅、ai-citation-strategist ✅、ecommerce-operator 🆕 | **5 / 5 ✅** |
...
`rosters/` 收錄「把既有角色依一個真實情境編成跨部門團隊」的配方檔（原創，MIT）。
目前有：

| 檔案 | 情境 |
|---|---|
| [`rosters/益生寵愛-寵物餐廳-O2O與OEM團隊.md`](rosters/益生寵愛-寵物餐廳-O2O與OEM團隊.md) | 中小型寵物餐廳的資源整合 → 價值共創 → 線上線下整合 → B2C 電商 + B2B OEM/ODM 雙軌商業模式，跨 8 個部門約 14 位數位員工，含毛孩（非人類利害關係人）代言線。對應教學模組在姊妹 repo。 |
